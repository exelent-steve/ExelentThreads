                ...
                <table class="csv-table">
                    <thead>
                        <tr>
                            ...
                            <th class="csv-cell csv-header" style="min-width: 120px;">Assignee</th>
                            <th class="csv-cell csv-header" style="min-width: 120px;">Last Responder</th>
        `;
                ...
                <tr>
                    ...
                    <td class="csv-cell" style="vertical-align: top;">
                        <span class="topic-responder-badge responder-${topic.lastResponder}">
                            ${topic.lastResponder === 'user' ? '⬅️ You' : topic.lastResponder === 'claude' ? '➡️ Claude' : '💬 None'}
                        </span>
                    </td>
            `;
